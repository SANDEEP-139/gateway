<!--=== Breadcrumbs ===-->
		<div class="breadcrumbs breadcrumbs-dark">
			<div class="container">
				<h1 class="pull-left">Youtube Video Category</h1>
				<ul class="pull-right breadcrumb">
					<li><a href="<?php echo base_url();?>">Home</a></li>
					
					<li class="active">Youtube Video Category</li>
				</ul>
			</div>
		</div>
		<!--=== End Breadcrumbs ===-->
            ...
            <?php if(!empty($CategoryList[0])){ foreach($CategoryList as $category){?>
				<div class="col-md-3 col-sm-6">
					<div class="view view-tenth">
						<img class="img-responsive" src="<?php if(!empty($category->filepath)){echo base_url('assets/frontend/upload/youtube/'.$category->filepath);}else
							{echo base_url('assets/frontend/img/nophoto.png');}?>" alt="" style="height:150px;" />
						<div class="mask">
							<h2><?php echo $category->category_name;?></h2>
							<a href="<?php echo base_url('web/showYoutube/'.$category->id);?>" class="info">More</a>
						</div>
					</div>
				</div>
                <?php }}else{?>
