            ...
            <div class="col-md-5">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Category (Video) <small>Edit</small></h3>
                    </div>
                   
                    <?php echo form_open_multipart('backend/web/editVidCategory/'.$EditVideo[0]['id']);?>
                        <div class="box-body">
                        	<?php echo $this->session->flashdata('msg'); ?>
                            <div class="form-group">
								<?php echo form_label('Category Name'); ?>
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$EditVideo[0]['category_name'], 'name' => 'category_name')); ?>
                                <input type="hidden" value="<?php echo $EditVideo[0]['category_name'];?>" name="category_name_hidden"/>
                            ...
                            <img src="<?php if(!empty($EditVideo[0]['filepath'])){echo base_url('assets/frontend/upload/video/'.$EditVideo[0]['filepath']);}else
