        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                   ...
                   <?php echo form_open_multipart('backend/web/updateVid/'.$EditVideo[0]['id']);?>
                        <div class="box-body">
                        	
                            <div class="form-group">
                                <label for="title">Image Title</label>
                                <input type="text" id="title" class="form-control" name="pagetitle" value="<?php echo $EditVideo[0]['title'];?>"/>
            ...
            <div class="box box-primary">
             ...
             <div class="box-body" style="height:250px; overflow:scroll;">
              <?php $data = explode(',', $EditVideo[0]['category_ids']); ?>
            ...
            <label>Live Status</label>
                        		...
                        		<option value="0" <?php echo $EditVideo[0]['status']==0?'selected':''; ?>>Inactive</option>
                                    <option value="1" <?php echo $EditVideo[0]['status']==1?'selected':''; ?>>Active</option>
                      			</select>
                                <span class="text-danger"><?php echo form_error('status'); ?></span>
            </div>
                        <div class="form-group">
                           <label>Set featured image</label>
                                <input type="file" class="form-control" style="height:auto;" name="feature_img" id="feature_img" value="<?php echo $EditVideo[0]['filepath']; ?>">
                                 <span class="text-danger"><?php echo form_error('feature_img'); ?></span>
                            </div>
                            <div class="col-md-12" >
                           <?php if($EditVideo[0]['filepath']!=''){
	$exten= explode('.', $EditVideo[0]['filepath']);
	?><video width="150" height="100" controls>
  <source src="<?php echo base_url('assets/frontend/upload/video/'.$EditVideo[0]['filepath']);?>" type="video/<?php echo $exten[1];?>">
