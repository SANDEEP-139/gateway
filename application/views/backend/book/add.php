        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                   ...
                   <?php echo form_open_multipart('backend/web/AddBook');?>
                        <div class="box-body">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Featured Book</h3>
                    </div>
                    <div class="box-body">
                    <div class="form-group">
            <label>Live Status</label>
                        ...
                        <img id="image_upload_preview" src="" alt=""/>
                            	<label>Cover Page Book (image)</label>
						...
						<div class="form-group">
                        <img id="image_upload_preview" src="" alt=""/>
                            	<label>Upload Book (Only PDF)</label>
