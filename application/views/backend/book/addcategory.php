            ...
            <div class="col-md-5">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Category (Book) <small>Add</small></h3>
                    </div>
                    <?php echo form_open_multipart('backend/web/addBookCategory/');?>
                        <div class="box-body">
            ...
            <div class="col-xs-7">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">Category (Book) List(s)</h3>
                    </div>
                        <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <img src="<?php if(!empty($book->filepath)){echo base_url('assets/frontend/upload/book/'.$book->filepath);}else
										{echo base_url('assets/frontend/img/nophoto.png');}?>"
                                         title="<?php echo $book->category_name; ?>" style="width:100px; height:100px;"/></td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('backend/web/editBookCategory/'.$book->id)?>" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
