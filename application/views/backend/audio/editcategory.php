<div class="content-wrapper">
    <section class="content-header">
        <h1><a href="#">Category (Audio)</a>
           
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Category (Audio)</li>
        </ol>
    </section>
            ...
            <div class="col-md-5">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Category (Audio) <small>Edit</small></h3>
                    </div>
                   
                    <?php echo form_open_multipart('backend/web/editAudioCategory/'.$EditAudio[0]['id']);?>
                        <div class="box-body">
                        	<?php echo $this->session->flashdata('msg'); ?>
                            <div class="form-group">
								<?php echo form_label('Category Name'); ?>
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$EditAudio[0]['category_name'], 'name' => 'category_name')); ?>
                                <input type="hidden" value="<?php echo $EditAudio[0]['category_name'];?>" name="category_name_hidden"/>
                             
                                <?php echo form_error('category_name', '<p class="text-danger">', '</p>'); ?>
                            </div>
                            <div class="form-group">
                            	<label>Set featured image</label>
                                <input type="file" class="form-control" style="height:auto;" name="feature_img" id="feature_img" value="<?php echo $EditAudio[0]['filepath']; ?>">
                                 <span class="text-danger"><?php echo form_error('feature_img'); ?></span>
                            </div>
                            <img id="image_upload_preview" src="" alt=""/>
                            <img src="<?php if(!empty($EditAudio[0]['filepath'])){echo base_url('assets/frontend/upload/audio/'.$EditAudio[0]['filepath']);}else
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <img src="<?php if(!empty($audio->filepath)){echo base_url('assets/frontend/upload/audio/'.$audio->filepath);}else
										{echo base_url('assets/frontend/img/nophoto.png');}?>"
                                         title="<?php echo $audio->category_name; ?>" style="width:100px; height:100px;"/></td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('backend/web/editImageCategory/'.$audio->id)?>" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
