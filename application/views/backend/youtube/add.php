        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                   ...
                   <?php echo form_open_multipart('backend/web/AddYoutube');?>
                        <div class="box-body">
                        	
                            <div class="form-group">
                                <label for="title">Youtube Title</label>
                            ...
                            <div class="form-group">
                            <label for="title">Youtube Description</label>
                            ...
                            <div class="form-group">
                            	<label>Youtube</label>
                                <input type="text" id="title" class="form-control" name="youtube" placeholder="Paste Youtube Link Here"/>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Featured Youtube</h3>
