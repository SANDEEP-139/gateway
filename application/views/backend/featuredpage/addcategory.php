<div class="content-wrapper">
    <section class="content-header">
        <h1><a href="#">Featured Page (<?php echo ucfirst($slug);?>)</a>
           
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Featured Page (<?php echo ucfirst($slug);?>)</li>
        </ol>
    </section>
            ...
            <div class="col-md-5">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Category (<?php echo ucfirst($slug);?>) <small>Add</small></h3>
                    </div>
                    <?php echo form_open_multipart('backend/web/addFeaturedPageCategory/'.$slug);?>
                        <div class="box-body">
