<div class="content-wrapper">
    <section class="content-header">
        <h1><a href="#">Category (<?php echo $slug;?>)</a>
           
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Category (<?php echo $slug;?>)</li>
        </ol>
    </section>
            ...
            <div class="col-md-5">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Category (<?php echo $slug;?>) <small>Edit</small></h3>
                    </div>
                   
                    <?php echo form_open_multipart('backend/web/editFeaturedPageCategory/'.$slug.'/'.$EditFeatured[0]['id']);?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <?php echo form_input(array('class'=>'form-control', 'value'=>$EditFeatured[0]['category_name'], 'name' => 'category_name')); ?>
                                <input type="hidden" value="<?php echo $EditFeatured[0]['category_name'];?>" name="category_name_hidden"/>
            ...
            <div class="col-xs-7">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">Category (<?php echo ucfirst($slug);?>) List(s)</h3>
                    </div>
                        <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $featured->category_name; ?></td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('backend/web/editFeaturedPageCategory/'.$slug.'/'.$featured->id)?>" title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
