        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                   ...
                   <?php echo form_open_multipart('backend/web/updateArticle/'.$EditArticle[0]['id']);?>
                        <div class="box-body">
                        	
                            <div class="form-group">
                                <label for="title">Image Title</label>
                                <input type="text" id="title" class="form-control" name="pagetitle" value="<?php echo $EditArticle[0]['title'];?>"/>
                            ...
                            <?php echo $EditArticle[0]['content'];?>
     						 </textarea>
            ...
            <label>Live Status</label>
            			 ...
            			 <div class="form-group">
                           ...
                           <img src="<?php echo base_url('assets/frontend/upload/article/'.$EditArticle[0]['coverpage']);?>" style="height:50px;" alt=""/>
                                <input type="file" class="form-control" style="height:auto;" name="coverpage" value="<?php echo $EditArticle[0]['coverpage']; ?>">
                                 <span class="text-danger"><?php echo form_error('coverpage'); ?></span>
                            </div>
                        <div class="form-group">
                        <input type="checkbox" name="isfile" value="1" <?php echo $EditArticle[0]['isfile']=='1'?'checked':''; ?>/><label> Is File open First </label><br>
                           <label>Update Article File</label>
                                <input type="file" class="form-control" style="height:auto;" name="feature_img" value="<?php echo $EditArticle[0]['filepath']; ?>">
                                 <span class="text-danger"><?php echo form_error('feature_img'); ?></span>
                            </div>
                            <?php if($EditArticle[0]['filepath']!=''){
	
	?><a href="<?php echo base_url('assets/frontend/upload/article/'.$EditArticle[0]['filepath']);?>">View</a>
<?php }else{?>
