        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-primary">
                   ...
                   <?php echo form_open_multipart('backend/web/AddArticle');?>
                        <div class="box-body">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Featured Article</h3>
                    </div>
                    <div class="box-body">
                    <div class="form-group">
            <label>Live Status</label>
                        ...
                        <img id="image_upload_preview" src="" alt=""/>
                                ...
                                <input type="file" class="form-control" style="height:auto;" name="coverpage" id="feature_img"/>
                                 <span class="text-danger"><?php echo form_error('coverpage'); ?></span>
                        </div>
						<div class="form-group">
                        <input type="checkbox" name="isfile" value="1"/><label> Is File open First </label>
